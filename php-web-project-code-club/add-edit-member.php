...
if (!empty($_POST)) {
    ...
    if (empty($_POST['id'])) {
         ...
         try {
            ...
            // Execute it here
            $createMemberStmt->execute(['first_name'=>$first_name, 'last_name'=>$last_name, 'address'=>$last_name, 'tier_id'=>$tier_id]);
        ...
        try {
            ...
            // Execute it here
            $updateMemberStmt->execute(['first_name'=>$first_name, 'last_name'=>$last_name, 'address'=>$last_name, 'tier_id'=>$tier_id, 'id'=>$id]);
